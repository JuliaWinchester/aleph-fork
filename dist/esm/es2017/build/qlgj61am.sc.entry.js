...
class AlControlPanel {
    ...
    static get style() { return "ion-item.sc-al-control-panel{--border-width:0 0 0 0;--inner-border-width:0 0 0 0}ion-item.sc-al-control-panel   select.sc-al-control-panel{padding:5px;min-width:100px}"; }
}

export { AlControlPanel };
