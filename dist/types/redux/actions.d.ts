...
export declare type ActionTypes = NullAction | AppClearAnglesAction | AppClearEdgesAction | AppClearNodesAction | AppDeleteAngleAction | AppDeleteEdgeAction | AppDeleteNodeAction | AppSelectAngleAction | AppSelectEdgeAction | AppSelectNodeAction | AppSetAngleAction | AppSetBoundingBoxEnabledAction | AppSetCameraAction | AppSetControlsEnabledAction | AppSetDisplayModeAction | AppSetEdgeAction | AppSetGraphEnabledAction | AppSetNodeAction | AppSetOrientationAction | AppSetSlicesIndexAction | AppSetSlicesWindowCenterAction | AppSetSlicesWindowWidthAction | AppSetSrcAction | AppSetSrcLoadedAction | AppSetVolumeStepsAction | AppSetVolumeWindowCenterAction | AppSetVolumeWindowWidthAction;
...
export declare const appSetSlicesWindowWidth: (payload: number) => (dispatch: any, _getState: any) => Promise<any>;
export interface AppSetSlicesWindowCenterAction {
    type: TypeKeys.APP_SET_SLICES_WINDOW_CENTER;
    payload: number;
}
export declare const appSetSlicesWindowCenter: (payload: number) => (dispatch: any, _getState: any) => Promise<any>;
